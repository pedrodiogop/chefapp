...
class _CriarreceitaState extends ConsumerState<Criarreceita> {
  ...
  bool get isFormValid =>
      ...
      isNumeric(caloriasdareceitaController.text) &&
      isNumeric(tempodareceitaController.text) &&
      isNumeric(precodareceitaController.text) &&
          ...
          TextButton(
            onPressed: () {
              if (isFormValid) {
                ...
                showSnackBar(context, 'Preencher Todos os Campos; \nOs Campos "Calorias" "Tempo" "Preço" tem de ser números inteiros');
              }
            },
            child: const Text(
              'Guardar',
          ...
          child: Column(
            children: [
              ...
              buildTextField(
                  ...
                  buildTextField('Preco', 'Preço em €', precodareceitaController, 1),
              const SizedBox(height: 10),
              ElevatedButton(
              ...
              const SizedBox(height: 10),
              buildTextField(
                  'Instruções de preparo', 'Instruções de preparo', comofazerdareceitaController, 5),
              const SizedBox(height: 10),
              Column(
